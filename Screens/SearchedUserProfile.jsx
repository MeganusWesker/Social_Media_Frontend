...
import { followUnfollowUser, getUserProfile, logOutUser } from "../redux/actions/userAction";
import { useMessageAndErrorUser, useMessageAndErrorUserWithoutNavigating } from "../utils/customHooks";
...
const SearchedUserProfile = ({ navigation,route }) => {
 ...
 const {error,message,getUserProfileLoading,searchedUser,searchedUserTotalLikes,isFollowed} =useSelector(state=>state.user);
  ...
  return (getUserProfileLoading===undefined || getUserProfileLoading===true) ? (
    <Loader />
  ) : (
    <>
    ...
    >
      ...
      >
        <ProfileHeader user={searchedUser} navigation={navigation} handler={()=>setVisible((prev)=>!prev)} />
        ...
        >
          <Avatar.Image
            size={size / 3}
            source={{ uri: searchedUser.avatar.url !==null ? searchedUser.avatar.url :defaultImg }}
            style={{
        ...
        >
            ...
            >
                ...
                >{searchedUser.posts.length}</Text>
            ...
            >
                ...
                >{searchedUser.followers.length}</Text>
            ...
            >
                ...
                >{searchedUser.following.length}</Text>
        ...
        >
            ...
            >
                ...
                {searchedUser.likedPosts?.map((item,i)=>(
                    <PhotoCollage
